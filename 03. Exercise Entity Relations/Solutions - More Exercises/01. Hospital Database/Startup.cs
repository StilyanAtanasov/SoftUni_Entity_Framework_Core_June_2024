...
public class Startup
{
    ...
    private void PrintVisitations()
    {
        ...
        foreach (var v in visitations)
            Console.WriteLine($"Id: {v.VisitationId} | Date: {v.Date} | Comments: {v.Comments} | PatientId: {v.PatientId}");
    }
    ...
    private void PrintMenu()
    {
        ...
        Console.WriteLine("6: Add Medicament");
        Console.WriteLine("7: Add Diagnoses");
        Console.WriteLine("8: Add Visitations");
        Console.WriteLine("9: Prescribe");
        Console.WriteLine("10: Find Patient");
        Console.WriteLine("11: Find Medicament");
